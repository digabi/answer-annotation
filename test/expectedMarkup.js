...
<div data-answer-id="1" class="answer selected hasComment ">
  ...
  <div class="originalAnswer" style="display: none">answer rich <img alt="math1" src="math.svg"> Text<br>Lorem ipsum<br><br><br></div>
...
<div data-answer-id="4" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer" style="display: none">answer rich <img alt="math1" src="math.svg"> Text<br>Lorem ipsum<br><img alt="math2" src="math.svg">+<img alt="math3" src="math.svg"></div>
...
<div data-answer-id="5" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer" style="display: none">answer rich <img alt="math1" src="math.svg"> Text<br>Lorem ipsum<br></div>
...
<div data-answer-id="6" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer" style="display: none">bi<br><img alt="math2" src="math.svg">+<img alt="math3" src="math.svg"></div>
...
<div data-answer-id="7" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer" style="display: none">answer rich <img alt="math1" src="math.svg"> Text<br>Morbi<br><img alt="math2" src="math.svg">+<img alt="math3" src="math.svg"></div>
...
<div data-answer-id="8" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer" style="display: none">X<img alt="math5" src="math.svg"><br><img alt="math6" src="math.svg"><br><img alt="math7" src="math.svg"><br></div>
...
<div data-answer-id="9" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer" style="display: none"><img alt="math1" src="math.svg"></div>
...
<div data-answer-id="10" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer" style="display: none"><img alt="math1" src="math.svg"><img alt="math2" src="math.svg"><img alt="math3" src="math.svg"></div>
...
<div data-answer-id="11" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer" style="display: none">ABCD<br><img alt="math1" src="math.svg"><img alt="math2" src="math.svg"><br>XYZ</div>
...
<div data-answer-id="12" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer" style="display: none">ABCD XYZ</div>
...
<div data-answer-id="15" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer" style="display: none">Lorem ipsum dolor sit amet. <br> <img src="sample_screenshot.jpg"><br> More text on another line<br>
