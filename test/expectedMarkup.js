...
<div data-answer-id="1" class="answer selected hasComment ">
...
<div class="answerText answerRichText annotatable is_pregrading"><span class="answerAnnotation">answer rich <img alt="math1" src="math.svg"> Text</span><br>Lorem ipsum<br><br><br></div>
...
<div data-answer-id="2" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer">answer rich <img alt="math1" src="math.svg"> Text<br>Lorem ipsum<br><br><br></div>
<div class="answerText answerRichText annotatable is_pregrading"><span class="answerAnnotation" data-message="great1" data-index="0">answe<sup class="annotationMessageIndex"></sup></span><i class="fa fa-comment"></i>r rich <img alt="math1" src="math.svg"> Text<br>Lorem ipsum<br><br><br></div>
<div class="answer-annotations">
  <div class="is_pregrading">
...
<div data-answer-id="3" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer">answer rich <img alt="math1" src="math.svg"> Text<br>Lorem ipsum<br><br><br></div>
<div class="answerText answerRichText annotatable is_pregrading"><span class="answerAnnotation" data-message="great1" data-index="0">answe<sup class="annotationMessageIndex"></sup></span><i class="fa fa-comment"></i>r rich <img alt="math1" src="math.svg"> Text<br>Lorem ipsum<br><br><br></div>
<div class="answer-annotations">
...
<div data-answer-id="4" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
...
<div data-answer-id="5" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
...
<div data-answer-id="6" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer">bi<br><img alt="math2" src="math.svg">+<img alt="math3" src="math.svg"></div>
  <div class="answerText answerRichText annotatable is_pregrading">bi<br><span class="answerAnnotation" data-message="great1" data-index="0"><img alt="math2" src="math.svg"><sup class="annotationMessageIndex"></sup></span><i class="fa fa-comment"></i>+<img alt="math3" src="math.svg"></div>
<div class="answer-annotations">
  <div class="is_pregrading">
  <table class="annotation-messages"><tr><td class="index"></td><td>great1</td></tr></table>
</div>
...
<div data-answer-id="7" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
...
<div data-answer-id="8" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer">X<img alt="math5" src="math.svg"><br><img alt="math6" src="math.svg"><br><img alt="math7" src="math.svg"><br></div>
  <div class="answerText answerRichText annotatable is_pregrading">X<span class="answerAnnotation" data-message="" data-index="0"><img alt="math5" src="math.svg"><br><img alt="math6" src="math.svg"></span><i class="fa fa-comment"></i><br><img alt="math7" src="math.svg"><br></div>
  <div class="answer-annotations">
  <div class="is_pregrading">
  <table class="annotation-messages"></table>
  </div>
...
<div data-answer-id="9" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer"><img alt="math1" src="math.svg"></div>
  <div class="answerText answerRichText annotatable is_pregrading"><span class="answerAnnotation" data-message="" data-index="0"><img alt="math1" src="math.svg"></span><i class="fa fa-comment"></i></div>
  <div class="answer-annotations">
  <div class="is_pregrading">
  <table class="annotation-messages"></table>
  </div>
...
<div data-answer-id="10" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer"><img alt="math1" src="math.svg"><img alt="math2" src="math.svg"><img alt="math3" src="math.svg"></div>
  <div class="answerText answerRichText annotatable is_pregrading"><span class="answerAnnotation" data-message="" data-index="0"><img alt="math1" src="math.svg"><img alt="math2" src="math.svg"></span><i class="fa fa-comment"></i><img alt="math3" src="math.svg"></div>
  <div class="answer-annotations">
  <div class="is_pregrading">
  <table class="annotation-messages"></table>
  </div>
...
<div data-answer-id="11" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer">ABCD<br><img alt="math1" src="math.svg"><img alt="math2" src="math.svg"><br>XYZ</div>
  <div class="answerText answerRichText annotatable is_pregrading">ABC<span class="answerAnnotation" data-message="" data-index="0">D<br><img alt="math1" src="math.svg"><img alt="math2" src="math.svg"></span><i class="fa fa-comment"></i><br>XYZ</div>
  <div class="answer-annotations">
  <div class="is_pregrading">
  <table class="annotation-messages"></table>
  </div>
...
<div data-answer-id="12" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer">ABCD XYZ</div>
<div class="answerText answerRichText annotatable is_pregrading">AB<span class="answerAnnotation" data-message="" data-index="0">CD</span><i class="fa fa-comment"></i> XYZ</div>
  <div class="answer-annotations">
  <div class="is_pregrading">
  <table class="annotation-messages"></table>
  </div>
...
<div data-answer-id="13" class="answer selected hasComment autograded">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer">ABCD XYZ</div>
<div class="answerText answerRichText annotatable is_pregrading">ABCD XYZ</div>
<div class="answer-annotations">
  <div class="is_pregrading">
  <table class="annotation-messages"></table>
  </div>
...
<div data-answer-id="14" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer">ABCD XYZ</div>
<div class="answerText answerRichText annotatable is_pregrading">AB<span class="answerAnnotation" data-message="comment text" data-index="0">CD<sup class="annotationMessageIndex"></sup></span><i class="fa fa-comment"></i> XYZ</div>
<div class="answer-annotations">
  <div class="is_pregrading">
...
<div data-answer-id="15" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
...
<div data-answer-id="16" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer">Lorem ipsum dolor sit amet. <br> <img src="sample_screenshot.jpg"><br> More text on another line<br>
<img src="sample_screenshot.jpg"><br> Even more text on third line.</div>
...
<div data-answer-id="17" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer">Lorem ipsum dolor sit amet. <br> <img src="sample_screenshot.jpg"><br> More text on another line<br>
<img src="sample_screenshot.jpg"><br> Even more text on third line.</div>
...
<div class="answer-annotations">
  ...
  <div data-answer-id="19" class="answer selected hasComment ">
  <div class="answer-text-container" style="position: relative; width: 100%">
  <div class="originalAnswer">answer rich <img alt="math1" src="math.svg"> Text<br>Lorem ipsum<br><br><br></div>
<div class="answerText answerRichText annotatable is_pregrading"><span class="answerAnnotation" data-index="0">answer rich </span><i class="fa fa-comment"></i><img alt="math1" src="math.svg"> Text<br>Lorem ipsum<br><br><br></div>
<div class="answer-annotations">
  <div class="is_pregrading">
  <table class="annotation-messages"></table>
  </div>
...
<div data-answer-id="20" class="answer selected hasComment" style="display: flex; flex-direction: column">
  <div class="answer-text-container" style="position: relative; width: 100%">
